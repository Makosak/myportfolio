...
excerpt: "A series of computational notebooks to introduce spatial data concepts. <br/><img src='/images/urbana.png'>"
...
We used the new classic, [Geographic Data Science](https://geographicdata.science/) by Rey et al (2025) to guide coding and learning throughout the course. The first three labs worked with data and concepts from the first three chapters of the text, reframed slightly to be more beginner-friendly. We used the UIUC [CyberGISX](https://cybergisxhub.cigi.illinois.edu/) environment as a standardized cloud interface for working with Python.
